        ...
        <section>
            <div class="container-info">
                <div class="info">
                    ...
                    <input type="text" name="nome_produto" placeholder="Digite o nome do produto" class="txt" maxlength="100" oninput="this.value = this.value.slice(0, 100)">
                ...
                <div class="info">
                    ...
                    <label>Marca</label>
                    <input type="text" name="marca" placeholder="Digite a marca" class="txt" maxlength="30" oninput="this.value = this.value.slice(0, 30)">
                ...
                <div class="info">
                    ...
                    <textarea class="txt" name="descricao_curta" rows="4" maxlength="200"
                        placeholder="Digite a descrição do produto..." id="descricao-curta"></textarea>
                    ...
                    <textarea class="txt" name="descricao" rows="6" maxlength="300"
                        placeholder="Digite a descrição detalhada..." id="descricao-detalhada"></textarea>
