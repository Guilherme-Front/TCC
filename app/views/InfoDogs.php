...
<body>
    ...
    <main>
        <section class="pet-dog-curiosidade">
            ...
            <div class="pet-img">
                <img class="image-dog" src="../../public/img/img-dog.webp" alt="Imagem do Cachorro">
            </div>
        </section>
            ...
            <div class="pet-flex-container">
                <div class="pet-container-alimentação">
                    ...
                    <div class="pet-paragrafo">
                        ...
                        <p class="pet-p1">
                            A alimentação do cachorro precisa ser feita de forma correta, considerando o estado de saúde
                            atual, a raça, o peso e o porte do animal, e claro, seguindo as recomendações veterinárias.

                            A quantidade de ração por animal é variável, bem como quantas refeições são necessárias por
                            dia. Geralmente, se segue estas orientações,

                            até 8 semanas: aleitamento materno.
                            De 2 a 4 meses: pequenas porções divididas em 4 vezes ao dia.
                            De 4 a 8 meses: alimentação dividida em porções 3 vezes ao dia.
                            Dos 8 meses em diante: 2 vezes ao dia.
                            Alguns cachorros podem ter recomendações específicas, em caso de dúvida é sempre ideal
                            consultar um veterinário de confiança.
                        ...
                        <p class="pet-p1">
                            A Ração <strong>Guabi Narual Cordeiro e Aveia</strong> para raças médias é uma opção Super
                        ...
                        <p class="pet-p1">
                            A <strong>Ração Bionatural Prime</strong> para cães de raças médias e grandes adultos, sabor
                            frango, é uma
                            opção Super Premium Natural desenvolvida com a orientação de veterinários.
                            Com ingredientes de alta qualidade, essa ração oferece diversos benefícios para a saúde do
                            seu pet, como a redução do tártaro, proteção e reforço das articulações com condroitina e
                            glucosamina, além de promover um intestino equilibrado com a combinação de prebióticos e
                            probióticos.
                            Sem corantes ou aromatizantes artificiais, é uma opção nutritiva e balanceada, disponível em
                            diferentes embalagens para atender às necessidades do seu cão.
                        </p>

                        <p class="pet-p1">
                            A <strong>Ração Biofresh Super Premium</strong> é indicada para cães adultos de porte mini
            ...
            <div class="pet-flex">
                <div class="pet-container-vacinas">
                    ...
                    <div class="pet-paragrafo">
                        ...
                        <p class="pet-p1">
                            Vacinar o cachorro é importante para prevenir doenças graves e infectocontagiosas, que podem
                        ...
                        <p class="pet-p1">
                            ...
                            Pomona e Grippotyphosa), parvovirose, coronavirose, hepatite infecciosa canina, adenovirose
                            e parainfluenza.
                        </p>
                        <p class="pet">
                        ...
                        <p class="pet-p1">Indicada na prevenção contra o adenovírus canino tipo 2, o vírus da
                            parainfluenza canina e na Bordetella bronchiseptica para cães acima de 8 semanas de idade.
                        ...
                        <p class="pet-p1">Indicada como auxiliar na prevenção infecciosa respiratória canina
                            (traqueobronquite infecciosa canina ou tosse dos canis) causada por em cães sadios a partir
                            de 8 semanas de idade. Uma dose única da vacina pela via oral é o suficiente para garantir a
                        ...
                        <p class="pet-p1">Defensor® é uma vacina inativada, indicada para vacinação de cães e gatos
                            sadios como auxiliar na prevenção da infecção pelo vírus da raiva. É indicada para cães e
